...
export class DemandeRapatriementService {
    ...
    autoriseDemande(idDemande: any): Observable<any> {
        ...
        return this.httpService.put<any>(environment.autorise_demande_rapatriement + '/' + idDemande, '').pipe(
            tap(response => {
    ...
    valideDemande(idDemande: any, data): Observable<any> {
        ...
        return this.httpService.put<any>(environment.valide_demande_rapatriement + '/' + idDemande, data).pipe(
            tap(response => {
                if (response['code'] === 200) {
                    console.log("response XHR", response)
                }
    ...
    initierDemande(idDemande: any): Observable<any> {
        ...
        return this.httpService.put<any>(environment.initierValidation_rapatriement + '/' + idDemande, '').pipe(
            tap(response => {
                if (response['code'] === 200) {
                    console.log("response XHR", response)
                }
    ...
    ajoutDemande(data: any): Observable<any> {
        ...
        return this.httpService.post<any>(environment.demande_rapatriement, data).pipe(
            tap(response => {
                if (response['code'] === 200) {
                    console.log("response XHR", response)
                }
